...
console.log(first.getAttribute('id')); //box
...
console.log(first.dataset.play); //set
...
function setAttr(node, prop, value){
  ...
  //비표준속성이면 dataset으로 설정하기 위해
  if(prop.includes('data')){
    let rest = prop.slice(5); //index 5부터 끝까지 -> data 부분 제거
...
console.log(getAttr('.first', 'data-value')); //hello
...
console.log(getAttr('.first', 'class')==='first');
setAttr('.second', 'data-value', 'hello'); */
